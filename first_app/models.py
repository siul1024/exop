...
class BuildingInfo(models.Model):
    ...
    bldg_lat = models.FloatField()
    bldg_lng = models.FloatField()
...
class ShopInfo(models.Model):
    ...
    bldg = models.ForeignKey(BuildingInfo, models.DO_NOTHING)
    cat = models.ForeignKey(Category, models.DO_NOTHING)
    shop_tel = models.CharField(max_length=13, blank=True, null=True)
